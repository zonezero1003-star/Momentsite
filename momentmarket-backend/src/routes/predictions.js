...
export function predictionsRouter({ backendWallet, latestOdds }) {
  ...
  router.post("/build", async (req, res) => {
    try {
      const { ownerPublicKey, fixtureId, match, predictedEvent, predictedWindow, predictedParticipant, backingTeamName, imageUri: providedImageUri } = req.body;
      ...
      pendingMintDetails.set(assetAddress, {
        ...
        predictedParticipant, backingTeamName, oddsAtPrediction, editionNumber,
      });
