...
function classicUnresolved({ match, predictedEvent, predictedWindow, oddsAtPrediction, editionNumber, editionCap }, theme) {
...
<svg width="640" height="900" viewBox="0 0 640 900" xmlns="http://www.w3.org/2000/svg">
  ...
  ${statRow(64, 480, "WINDOW", predictedWindow || "Full match")}
  ${statRow(64, 540, "ODDS AT PREDICTION", String(oddsAtPrediction ?? "—"))}
